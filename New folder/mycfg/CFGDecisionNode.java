...
public class CFGDecisionNode extends CFGNode implements ICFGDecisionNode {
	...
	public CFGDecisionNode(ICFG cfg, IExpression c, ICFEdge t, ICFEdge e) {
		this.mCFG = cfg;
		if(cfg != null) {
	...
	public CFGDecisionNode(String id, ICFG cfg, IExpression c, ICFEdge t, ICFEdge e) throws Exception {
		this.mCFG = cfg;
		if(cfg != null) {
			cfg.addDecisionNode(this);
		}
