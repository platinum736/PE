...
public class TestSumConstantDelay {
	...
	public void test() {
		Document doc = ParseXML
				.initializeDocument("C:/Users/rishabh-pc/Documents/GitHub/PE/SimulinkEquivBlocks/TestFiles/ConstantSumDelay.xml");
			...
			*/
			...
			if (blockName != "" && blockType != null) {
				...
				if (blockName.startsWith(Constants.SUB_SYS)) {
					...
					{
						assertEquals(((Delay)block).getDelayLength(),1);
					}
